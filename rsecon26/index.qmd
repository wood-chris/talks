...
This is an early proof of concept so we can make assumptions like no viable walking route on islands without a GP surgery - much more detailed analysis could determine whether including ferries as public transport is a sensible thing to do
:::
...
There are _two_ official lists of GPs in Scotland:
 ...
 - Spatial DataHub Scotland
    - richer data (contains UPRN), but last updated October 2020
...
::: {.fragment}
 ...
 - some GP surgeries have moved and kept the same Practice Code
...
\* For testing, all GPs were geolocated based on postcode 
...
## Results
 ...
 - 693 GPs (+ 3 unknown)
 - ~3990 uprns per GP
 - 1183 km^2^ average area _but_ standard deviation of 2132!
...
All the results are means of the stats, so beware!!
 - highlight time efficiency!! this graph generation + distance calculation, excludes i/o for other datasets (e.g. UPRNs, but these are 1 off actions)
...
[c.wood@epcc.ed.ac.uk]{.smallcaps}
